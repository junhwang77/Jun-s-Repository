...
class UserManager(models.Manager):
    ...
    def registerValid(self, first_name, last_name, email, description, password, pass_conf):
        errors = []
        if len(email) == 0:
        ...
        if len(errors) is not 0:
            ...
            e = Users.usermanager.create(email=email, first_name=first_name, last_name=last_name, pw_hash=pw_hash, description=description)
            e.save()
            return (True, e)
